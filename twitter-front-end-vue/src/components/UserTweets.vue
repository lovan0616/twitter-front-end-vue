      ...
      <div class="tweet d-flex p-2">
        ...
        <div class="content-area w-100">
          <div class="post-info d-flex">
            ...
            <div class="setting-control" v-show="user.isSelf">
              <div
                class="dot-wrapper"
          ...
          <div class="post-engage d-flex">
            ...
            <div class="like-control d-flex ml-3" v-if="!isSelfTweet()">
              ...
              />
              <p class="like-counts mb-0 ml-2" v-if="!tweet.isLike">
                {{ tweet.likesCount }}
              </p>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <form @submit.stop.prevent="saveEdit(tweet.id, tweet.description)">
              <textarea
                class="w-100 mt-3"
                name="description"
                id="description"
